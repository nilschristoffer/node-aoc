...
import { solveStar1, solveStar2 } from "./day03";
const DAY = parseInt(
...
describe("Day " + DAY, () => {
  it("should pass test", () => {
    expect(solveStar1(testInput)).toBe(161);
  });

  it("should solve star 1", () => {
    expect(solveStar1(input)).toBe(183669043);
  });

  it("should pass test for star 2", () => {
    expect(solveStar2(testInput2)).toBe(48);
  });

  it("should solve star 2", () => {
    expect(solveStar2(input)).toBe(59097164);
  });
});
