...
import { solveStar1, solveStar2 } from "./day02";
const DAY = parseInt(
...
describe("Day " + DAY, () => {
  it("should pass test", () => {
    expect(solveStar1(testInput)).toBe(2);
  });

  it("should solve star 1", () => {
    expect(solveStar1(input)).toBe(202);
  });

  it("should pass test for star 2", () => {
    expect(solveStar2(testInput)).toBe(4);
  });

  it("should solve star 2", () => {
    expect(solveStar2(input)).toBe(271);
  });
});
