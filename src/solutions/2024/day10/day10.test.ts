...
import { solveStar1, solveStar2 } from "./day10";
const DAY = parseInt(
...
describe("Day " + DAY, () => {
  it("should pass test 2", () => {
    expect(solveStar1(testInput2)).toBe(3);
  });

  it("should pass test", () => {
    expect(solveStar1(testInput)).toBe(36);
  });

  it("should solve star 1", () => {
    expect(solveStar1(input)).toBe(461);
  });

  it("should pass test for star 2", () => {
    expect(solveStar2(testInput)).toBe(81);
  });

  it("should solve star 2", () => {
    expect(solveStar2(input)).toBe(875);
  });
});
